...
function landing_scripts() {
	...
	wp_enqueue_style( 'animate', __BASE_URL__.'/css/lib/animate.css' , array(), _S_VERSION );
	wp_enqueue_style( 'slick', __BASE_URL__.'/css/lib/slick.min.css' , array(), _S_VERSION );
	wp_enqueue_style( 'slick-theme', __BASE_URL__.'/css/lib/slick-theme.min.css' , array(), _S_VERSION );
	wp_enqueue_style( 'mmenu', __BASE_URL__.'/css/lib/jquery.mmenu.all.css' , array(), _S_VERSION );
	...
	wp_enqueue_script( 'bootstrap-js', __BASE_URL__.'/js/lib/bootstrap.min.js' , array(), _S_VERSION, true );
	wp_enqueue_script( 'wow-js', __BASE_URL__.'/js/lib/wow.min.js' , array(), _S_VERSION, true );
	wp_enqueue_script( 'slick-js', __BASE_URL__.'/js/lib/slick.min.js' , array(), _S_VERSION, true );
	wp_enqueue_script( 'mmenu-js', __BASE_URL__.'/js/lib/jquery.mmenu.all.js' , array(), _S_VERSION, true );
	wp_enqueue_script( 'count-js', __BASE_URL__.'/js/lib/countdown.min.js' , array(), _S_VERSION, true );
